...
export function renderFooter(contact = {}) {
  ...
  return `<footer class="site-footer"><div class="footer-top"><div><a href="#" class="brand">${wordmark()}</a><p>La vida se disfruta<br>un bocado a la vez.</p></div><div class="footer-links"><h2>¿Se te antoja?</h2><a href="#shop">Las cookies</a><a href="#sales">Dónde encontrarnos</a><a href="#about">Sobre Snackyzz</a></div><div class="footer-contact"><h2>Sigamos en contacto</h2><p class="social-handle">${icon("instagram")} @${e(instagram)}</p><a href="mailto:${e(email)}">${icon("mail")} ${e(email)}</a><p>Escríbenos. Nos encantará leerte.</p></div></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} Snackyzz. Todos los derechos reservados.</span><a href="#admin">Administración ${icon("arrow")}</a></div></footer>`;
}
